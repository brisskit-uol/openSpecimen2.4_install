...
public class caTissueParser_PidSet {
	...
	private String bpt_number=null;
	...
	public String getBpt_number() {
		return bpt_number;
	}
	public void setBpt_number(String bpt_number) {
		this.bpt_number = bpt_number;
	}
